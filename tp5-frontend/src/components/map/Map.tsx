...
export const Map = () =>{
    return(
        <Container fluid className="text-center mt-2 mb-2 text-white bg-dark p-5 display-6 font-weight-bold">
            ...
            <iframe title={"mapa"}
                    ...
                    width="600" height="450" loading="lazy" style={{ width: "100%", height: "500px" }}
